...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "sendpledgetoaddress", 1, "amount" },
    { "sendpledgetoaddress", 4, "subtractfeefromamount" },
    { "sendpledgetoaddress", 5, "replaceable" },
    { "sendpledgetoaddress", 6, "conf_target" },
    { "withdrawpledge", 3, "replaceable" },
    { "withdrawpledge", 4, "conf_target" },
    { "listpledges", 0, "count" },
    { "listpledges", 1, "skip" },
    { "listpledges", 2, "include_watchonly" },
    { "listpledges", 3, "include_invalid" },
    { "getplottermininginfo", 1, "verbose" },
    { "getchaintips", 0, "verbose" },

    /* BitcoinHD1 & Burst mining compatible */
