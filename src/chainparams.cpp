...
public:
    CMainParams() {
        ...
        consensus.BHDIP009Height = 830125; // 2023/4/17 15:00
        ...
        consensus.BHDIP009PlotIdBitsOfFilterEnableOnHeight = consensus.BHDIP009Height + 800;
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back("timelord.bhd.one");
