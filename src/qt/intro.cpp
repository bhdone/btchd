...
{
    ui->setupUi(this);
    ui->welcomeLabel->setText(ui->welcomeLabel->text().arg(BitcoinGUI::tr(PACKAGE_NAME)));
    ui->storageLabel->setText(ui->storageLabel->text().arg(BitcoinGUI::tr(PACKAGE_NAME)));
    ...
    ui->sizeWarningLabel->setText(
        tr("%1 will download and store a copy of the BitcoinHD1 block chain.").arg(BitcoinGUI::tr(PACKAGE_NAME)) + " " +
