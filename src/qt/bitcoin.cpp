...
static const char* qt_argv = "btchd-qt";
...
static void SetupUIArgs()
{
    ...
    gArgs.AddArg("-qtstyle", "Qt GUI style, Example fusion. See https://doc.qt.io/qt-5/qstylefactory.html", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::GUI);
}
...
int GuiMain(int argc, char* argv[])
{
    ...
    if (!CheckDataDirOption()) {
        ...
        QMessageBox::critical(nullptr, BitcoinGUI::tr(PACKAGE_NAME),
    ...
    try {
        ...
        QMessageBox::critical(nullptr, BitcoinGUI::tr(PACKAGE_NAME), QObject::tr("Error: %1").arg(e.what()));
        return EXIT_FAILURE;
    }
#ifdef ENABLE_WALLET
...
#if defined(Q_OS_WIN)
            WinShutdownMonitor::registerShutdownBlockReason(QObject::tr("%1 didn't yet exit safely...").arg(BitcoinGUI::tr(PACKAGE_NAME)), (HWND)app.getMainWinId());
#endif
            app.exec();
            app.requestShutdown();
            app.exec();
